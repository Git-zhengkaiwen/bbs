...
public class UserController implements BlogConstant {
    ...
    public String updateHeaderUrl(String fileName) {
        if (StringUtils.isBlank(fileName)) {
            return BlogUtil.getJSONString(1, "文件名不能为空!");
        }
