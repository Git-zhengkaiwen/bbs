package com.myproject.blog.quartz;
...
import com.myproject.blog.util.RedisKeyUtil;
...
public class PostScoreRefreshJob implements Job, BlogConstant {
    ...
    static {
        try {
            epoch = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("1900-01-01 00:00:00");
        } catch (ParseException e) {
            throw new RuntimeException("初始化起始时间失败!", e);
        }
    }
